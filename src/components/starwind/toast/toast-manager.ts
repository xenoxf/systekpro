...
/**
 * Wait for the toast manager to be available
 */
function waitForManager(maxAttempts = 50, interval = 100): Promise<ToastManager | null> {
 ...
 */
async function createVariantToast(
  variant: Variant,
  message: string,
 ...
 */
interface ToastAPI {
  (message: string, options?: Omit<ToastOptions, "title">): Promise<string>;
  (options: ToastOptions): Promise<string>;
  success(message: string, options?: Omit<ToastOptions, "variant">): Promise<string>;
  error(message: string, options?: Omit<ToastOptions, "variant">): Promise<string>;
  warning(message: string, options?: Omit<ToastOptions, "variant">): Promise<string>;
  info(message: string, options?: Omit<ToastOptions, "variant">): Promise<string>;
  loading(message: string, options?: Omit<ToastOptions, "variant">): Promise<string>;
